...
(function () {
  ...
  var translations = {
    zh: {
      ...
      "currentProject.text": "我正在为艺术家制作和混合整张专辑，作为我大学的最终项目。更新和预览将很快添加在这里。",
      "contact.heading": "联系",
      "contact.text": "你有钱吗？",
    ...
    he: {
      ...
      "xp.ok": "אישור",
      "xp.help.title": "עזרה",
      "xp.help.firstMsg": "מה ציפית שיקרה?",
      "xp.mixing.title": "מאפייני מיקסינג",
      "xp.mastering.title": "מאפייני מאסטרינג",
      "xp.photo.title": "מאפייני תמונה",
      "xp.credits.tab": "קרדיטים",
      "xp.photo.tab": "הגדרות",
      "xp.mixing.groupLabel": "קרדיטים - מיקסינג",
      "xp.mastering.groupLabel": "קרדיטים - מאסטרינג",
      "xp.photo.groupLabel": "מידע מצלמה",
      "xp.credits.colProject": "פרויקט:",
      "xp.credits.colDetails": "פרטים:",
      "xp.photo.colItem": "שם פריט:",
      "xp.photo.colValue": "ערך:",
      "xp.noData": "אין נתונים",
      "xp.noMeta": "אין מטא-נתוני מצלמה.",
      "xp.exif.camera": "מצלמה",
      "xp.exif.lens": "עדשה",
      "xp.exif.focal": "מרחק מוקד",
      "xp.exif.aperture": "צמצם",
      "xp.exif.shutter": "מהירות תריס",
      "xp.exif.iso": "ISO",
      "xp.exif.date": "תאריך"
    },
    en: {
